# Next aim is to turn this into a scientific calculator


from tkinter import *

window = Tk() # Initialising the Tinker window
window.geometry("385x324") # Picking the size of the window
window.resizable(0, 0) # Stopping the window from being resized.
